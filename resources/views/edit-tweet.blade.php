                                                   ...
                                                   <div class="row">
                                                       ...
                                                       <div class="col-sm">
                                                           <form method="POST" action="/edit-tweet/{{ $tweet->id }}">
                                                              @csrf
                                                               <textarea name="tweet" class="form-control" rows="1" placeholder="What's happening?" required>{{ $tweet->tweet }}</textarea>
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 tweet-buttons">
                                                            <a href="/edit-comment/{id}/{{ $comment->id }}"><i class="far fa-edit"></i></a>
                                                        </div>
                                                        <div class="col-md-3 tweet-buttons">
                                                            <form method="POST" action="/like-tweet">
                                                             @csrf
