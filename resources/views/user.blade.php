                                       ...
                                       <div class="card card-default">
                                           ...
                                           <div class="card-body">
                                            ...
                                            {{-- @foreach ($potentialFollowers as $potentialFollower) --}}
                                              {{-- <form method="post" action="user-display/{{$id}}">
                                                @csrf
                                                   ...
                                                   <div>
                                                      ...
                                                      <h4 class="media-heading">{{ $potentialFollower ->name}}</h4>
                                                       <a href="/user-display/{{ $potentialFollower->id }}">{{ $potentialFollower ->name}}
                                                       <a href="{{ route('user.follow', $user) }}" class="btn btn-default btn-xs">Follow</a>
                                                       <div class="container">
                                                           <div class="row">
                                                               <div class="col-md-12">
                                                       ...
                                                       <div class="container">
                                                           ...
                                                           <div class="row">
                                                             ...
                                                             <div class="col-md-4 tweet-buttons">
                                                                   <form name="edit-comment-form" method="POST" action="/edit-comment/{id}{{ $comment->id }}">
                                                                   @csrf
                                                                       <textarea name="comment" class="form-control" placeholder="what's happening?">{{$comment->comment}}</textarea>
                                                                       <input type="hidden" name="comment_id" value="{{ $comment->id }}">
                                                                       <button type="submit" class="btn btn-primary">{{ __('Edit Comment') }}</button>
                                                                    </form>
                                                               </div>
                                                               <div class="col-md-3">
